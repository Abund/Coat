...
import com.example.coat.adapter.AdapterComment;
import com.example.coat.model.Comments;
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    Comments modelComment = ds.getValue(Comments.class);
                    ...
                    //setup adapter
                    adapterComments = new AdapterComment(getApplicationContext(), commentList, myUid, postId);
                    //set adapter
        ...
        likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(postId).hasChild(myUid)){
                    ...
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_thumb_liked, 0,0,0);
                    ...
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_thumb_up_black_24dp, 0,0,0);
