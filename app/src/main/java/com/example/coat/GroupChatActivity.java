...
import com.example.coat.adapter.AdapterGroupChat;
import com.example.coat.model.GroupChat;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            try {
                                Picasso.get().load(groupIcon).placeholder(R.drawable.ic_group_black_24dp).into(groupIconIv);
                            }
                            catch (Exception e){
